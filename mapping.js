...
function startPolling() {   
    ...
    setInterval(function() {
        fetch('https://mysterious-bastion-23207.herokuapp.com/http://api.open-notify.org/iss-now.json') //CORS Anywhere used due to HTTP
...
function peopleInSpace() {
    ...
    fetch('https://mysterious-bastion-23207.herokuapp.com/http://api.open-notify.org/astros.json')
        .then(response => response.json())
        .then(people => {
...
function passTimes(lon, lat) {
    // Uses 'cors-anywhere' proxy to add Access-Control-Allow-Origin: * to response header
    let url = new URL('https://mysterious-bastion-23207.herokuapp.com/http://api.open-notify.org/iss-pass.json')
